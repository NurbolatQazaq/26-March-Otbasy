	...
	return {
		viewConfigDiff: /**SCHEMA_VIEW_CONFIG_DIFF*/[
			...
			},
			{
				...
				"values": {
					"type": "crt.Button",
					"caption": "#ResourceString(Button_qkqz1dw_caption)#",
					"color": "default",
					"disabled": false,
					"size": "large",
			...
			{
				"operation": "insert",
				"name": "MenuItem_6srbgu0",
				"values": {
					"type": "crt.MenuItem",
					"caption": "#ResourceString(MenuItem_6srbgu0_caption)#",
					"visible": true,
					"clicked": {
		...
		handlers: /**SCHEMA_HANDLERS*/[
		   ...
		   },
			{
				...
				handler: async (request, next) => {
					...
					var typeObject = await request.$context.PDS_UsrDriveType_9xjvmbu;
					var driveTypeId = "";
					if (typeObject) {
